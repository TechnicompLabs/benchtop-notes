...
NOTE: iwd was previously considered as a wpa_supplicant replacement for this distro, but this plan has been abandoned. iwd itself is still actively maintained by Intel, but integration issues with NetworkManager and missing enterprise WPA features made it unsuitable as a default. Keeping notes for reference.

##### Stop Services
	systemctl stop NetworkManager
	systemctl disable --now wpa_supplicant
	    Note: I'd recommend just uninstalling this. Make sure "Cleanup when deleting packages" is selected to ensure cleanup of all dependencies

##### /etc/iwd/main.conf
#ToDo Decide on better settings; SteamOS doesn't have any settings at all
	[General]
	RoamThreshold=-75
	RoamThreshold5G=-80
