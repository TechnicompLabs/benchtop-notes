...
##### /etc/sysctl.d/10-vm-default-settings.conf
    vm.swappiness = 180
...
vm.swappiness=180 is too high for realtime audio. For audio production, set vm.swappiness=10 in /etc/sysctl.conf and run 'sysctl --system'.
See https://wiki.linuxaudio.org/wiki/system_configuration#sysctlconf

## Transparent Hugepages

###### /etc/tmpfiles.d/99-thp.conf
